        ...
        <div className={`lg:hidden overflow-hidden transition-all duration-300 ease-in-out ${isMenuOpen ? 'max-h-[30rem] opacity-100 border-t border-stone-200 mt-2' : 'max-h-0 opacity-0'}`}>
          <div className="bg-brand-linen px-5 py-4 space-y-2">
            ...
            <div className="pt-2 flex items-center gap-3">
              ...
              <a href="https://www.tiktok.com/@ecobags81?_r=1&_t=ZS-9A0JdEMZ8XX" target="_blank" rel="noopener noreferrer" className="w-8 h-8 rounded-full bg-brand-forest/10 text-brand-forest hover:bg-brand-forest hover:text-white flex items-center justify-center transition-colors" aria-label="TikTok">
