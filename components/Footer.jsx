...
export const Footer = () => {
  ...
  return (
    <footer className="bg-brand-forest text-stone-300 font-sans border-t border-white/10 relative overflow-hidden">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-8 lg:gap-10">
          ...
          <div className="lg:col-span-4 text-center md:text-left space-y-4">
            ...
            <div className="pt-2 flex items-center justify-center md:justify-start space-x-3 text-stone-400">
              <a href="/facebook" target="_blank" rel="noopener noreferrer" className="w-8 h-8 rounded-full bg-white/10 hover:bg-brand-mint hover:text-brand-forest flex items-center justify-center transition-colors flex-shrink-0" aria-label="Eco Print & Pack Facebook" title="Facebook">
              ...
              <a href="/instagram" target="_blank" rel="noopener noreferrer" className="w-8 h-8 rounded-full bg-white/10 hover:bg-brand-mint hover:text-brand-forest flex items-center justify-center transition-colors flex-shrink-0" aria-label="Eco Print & Pack Instagram" title="Instagram">
              ...
              <a
                ...
                className="w-8 h-8 rounded-full bg-white/10 hover:bg-black hover:text-white flex items-center justify-center transition-colors flex-shrink-0"
      ...
      {/* Floating WhatsApp Button (Rolls to circular icon after 2.5s, expands on hover) */}
      <a
        href="https://wa.me/9779869268248?text=Hello%20Eco%20Print%20%26%20Pack!%20I%20am%20interested%20in%20your%20products."
        target="_blank"
        rel="noopener noreferrer"
        className="fixed bottom-6 right-6 z-50 flex items-center bg-[#25D366] hover:bg-[#20ba5a] text-white rounded-full shadow-xl hover:shadow-2xl transition-all duration-500 ease-in-out hover:scale-105 group h-14"
      ...
      >
        ...
        <div
          className={`overflow-hidden transition-all duration-500 ease-in-out whitespace-nowrap flex items-center ${
            isRolled
              ? 'max-w-0 pr-0 opacity-0 group-hover:max-w-xs group-hover:pr-5 group-hover:opacity-100'
              : 'max-w-xs pr-5 opacity-100'
          }`}
        >
