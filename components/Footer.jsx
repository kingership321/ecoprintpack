        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-8 lg:gap-10">
          ...
          <div className="lg:col-span-4 text-center md:text-left space-y-4">
            ...
            <div className="pt-2 flex items-center justify-center md:justify-start space-x-3 text-stone-400">
              <a href="https://www.facebook.com/61581404986839/" target="_blank" rel="noopener noreferrer" className="w-8 h-8 rounded-full bg-white/10 hover:bg-brand-mint hover:text-brand-forest flex items-center justify-center transition-colors" aria-label="Facebook">
              ...
              <a href="https://www.instagram.com/ecobagssupplier?stkn=YzhpaHlxdGRqZTAw&utm_source=qr" target="_blank" rel="noopener noreferrer" className="w-8 h-8 rounded-full bg-white/10 hover:bg-brand-mint hover:text-brand-forest flex items-center justify-center transition-colors" aria-label="Instagram">
              ...
              <a href="https://www.tiktok.com/@ecobags81?_r=1&_t=ZS-9A0JdEMZ8XX" target="_blank" rel="noopener noreferrer" className="w-8 h-8 rounded-full bg-white/10 hover:bg-brand-mint hover:text-brand-forest flex items-center justify-center transition-colors" aria-label="TikTok">
                <svg className="h-3.5 w-3.5" fill="currentColor" viewBox="0 0 24 24"><path d="M12.53.02C13.84 0 15.14.01 16.44 0c.08 1.53.63 3.09 1.75 4.17 1.12 1.11 2.7 1.62 4.24 1.79v4.03c-1.44-.05-2.89-.35-4.2-.97-.57-.26-1.1-.59-1.62-1.01v8.42c0 1.25-.24 2.51-.78 3.63-1.05 2.22-3.13 3.86-5.57 4.28-2.45.42-5.06-.29-6.94-1.92-1.89-1.64-2.88-4.07-2.67-6.55.2-2.49 1.59-4.73 3.68-5.96 1.88-1.11 4.19-1.39 6.28-.77.01 1.45.02 2.89.01 4.34-.84-.28-1.77-.32-2.61-.08-.94.26-1.74.88-2.21 1.71-.48.83-.59 1.84-.33 2.76.26.92.89 1.7 1.72 2.15.84.45 1.84.53 2.77.25.93-.28 1.69-.96 2.08-1.84.27-.61.37-1.28.37-1.95V.02z"/></svg>
              </a>
            </div>
          </div>
